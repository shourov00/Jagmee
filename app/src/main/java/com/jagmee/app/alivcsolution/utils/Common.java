package com.jagmee.app.alivcsolution.utils;
    ...
    private void copyAssetsToDst(Context context, String srcPath, String dstPath) {
        try {
            ...
            if (fileNames.length > 0) {
                File file = new File(context.getExternalFilesDir(""), dstPath);
                if (!file.exists()) {
                    file.mkdirs();
                }
                ...
                File outFile = new File(context.getExternalFilesDir(""), dstPath);
