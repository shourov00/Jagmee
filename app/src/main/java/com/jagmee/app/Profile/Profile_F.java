...
public class Profile_F extends RootFragment implements View.OnClickListener {
    private static final String TAG = "Profile_F";
                ...
                switch (tab.getPosition()){
                    case 0:
                      //  image.setImageDrawable(getResources().getDrawable(R.drawable.ic_my_video_gray));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.dimgray), android.graphics.PorterDuff.Mode.MULTIPLY);
    ...
    public void Parse_data(String responce){
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                Log.e(TAG, "Parse_data:  user data "+user_info );
