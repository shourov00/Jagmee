...
import com.jagmee.app.Settings.Setting_F;
...
import com.jagmee.app.Following.Following_F;
import com.jagmee.app.Main_Menu.MainMenuActivity;
import com.jagmee.app.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.jagmee.app.Profile.Liked_Videos.Liked_Video_F;
import com.jagmee.app.Profile.UserVideos.UserVideo_F;
import com.jagmee.app.R;
import com.jagmee.app.See_Full_Image_F;
import com.jagmee.app.SimpleClasses.Functions;
import com.jagmee.app.SimpleClasses.Variables;
import com.jagmee.app.Video_Recording.DraftVideos.DraftVideos_A;
    ...
    public void update_profile(){
        ...
        try {
            ...
            Picasso.with(context).load(pic_url)
                    .resize(200, 200)
                    .placeholder(R.drawable.find_user_male)
                    .centerCrop()
                    .into(imageView);
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                Picasso.with(context)
                        .load(pic_url)
                        .centerCrop()
                        .placeholder(context.getResources().getDrawable(R.drawable.find_user_male)).resize(200,200)
                        .into(imageView);
