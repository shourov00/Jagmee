package com.jagmee.app.Profile.UserVideos;
...
import com.jagmee.app.Profile.MyVideos_Adapter;
...
import com.jagmee.app.WatchVideos.WatchVideos_F;
...
public class UserVideo_F extends Fragment {
    private static final String TAG = "UserVideo_F";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        }, new MyVideos_Adapter.OnItemLongClickListener() {
            @Override
            public void onItemLongClick(final int postion, final Home_Get_Set item, View view) {
                                ...
                                case DialogInterface.BUTTON_POSITIVE:
                                    ...
                                    Functions.Call_Api_For_Delete_Video(getActivity(), item.video_id, new API_CallBack() {
                                        ...
                                        public void ArrayData(ArrayList arrayList) {
                                            Log.e(TAG, "ArrayData: "+arrayList );
                                        }

                                        @Override
                                        public void OnSuccess(String responce) {
                                            Log.e(TAG, "OnSuccess: "+responce );
