...
public class Home_Adapter extends RecyclerView.Adapter<Home_Adapter.CustomViewHolder > {
    ...
    public void onBindViewHolder(final Home_Adapter.CustomViewHolder holder, final int i) {
        ...
        holder.desc_txt.setText(item.video_description);
            if(item.follow.equals("1")) {
                holder.myfollow.setImageDrawable(context.getResources().getDrawable(R.drawable.correctone));
            }else{
                holder.myfollow.setImageDrawable(context.getResources().getDrawable(R.drawable.vector));
            }
        ...
        Picasso.with(context).
            ...
            Log.e(TAG, "onBindViewHolder: item like or dislike "+item.liked+"  username "+item.username );
        if(item.liked.equals("1")){
            Log.e(TAG, "onBindViewHolder: like "+item.liked );
            holder.like_image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_like_fill));
        }
       else {
            Log.e(TAG, "onBindViewHolder: not like "+item.liked );
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView user_pic,sound_image,varified_btn, report, myfollow;

        LinearLayout like_layout,comment_layout,shared_layout,download_layout,sound_image_layout, dute_layout;
        ...
        public CustomViewHolder(View view) {
            ...
            dute_layout=view.findViewById(R.id.dute_layout);
        ...
        public void bind(final int postion,final Home_Get_Set item, final Home_Adapter.OnItemClickListener listener) {
            ...
            dute_layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClick(postion,item,v);
                }
