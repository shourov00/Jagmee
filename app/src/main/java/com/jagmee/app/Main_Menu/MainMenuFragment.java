...
import com.jagmee.app.Notifications.Notification_F;
...
import com.jagmee.app.Discover.Discover_F;
import com.jagmee.app.Home.Home_F;
import com.jagmee.app.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.jagmee.app.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.jagmee.app.Profile.Profile_Tab_F;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_red));
        title1.setText("Home");
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_discovery_white));
        ...
        imageView5.setImageDrawable(getResources().getDrawable(R.drawable.ic_profile_red));
        ...
        //wrapTabIndicatorToTitle(tabLayout,69,69);
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        ...
                        image.setColorFilter(ContextCompat.getColor(context, R.color.cyan), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.cyan));
                        break;
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        ...
                        break;
                    case 1:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_discovery_white));
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;
    ...
    public void Onother_Tab_Click(){
        ...
        tex0.setTextColor(context.getResources().getColor(R.color.white));
        ...
        tabLayout.setSelectedTabIndicatorColor(getResources().getColor(R.color.cyan));
    ...
    private void wrapTabIndicatorToTitle(TabLayout tabLayout, int externalMargin, int internalMargin) {
    ...
    public void startRecording(){
        final AlivcRecordInputParam recordInputParam = new AlivcRecordInputParam.Builder()
                ...
                .build();
        AlivcSvideoRecordActivity.startRecord(getActivity(), recordInputParam);
    }
}