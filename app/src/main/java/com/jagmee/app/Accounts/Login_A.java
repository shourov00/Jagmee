package com.jagmee.app.Accounts;
...
public class Login_A extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==123){
            Log.e("onActivityResult", "if working");
    ...
    public void Sign_in_with_gmail(){
        ...
        if (account != null) {
            Log.e("TAG G Login", "Working if start");
            ...
            Log.e("TAG G Login", "Working if end");

        }
        else {
            Log.e("TAG G Login", "Working else ");
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            Log.e("handleSignInResult", "working start");
            GoogleSignInAccount account = completedTask.getResult(ApiException.class);
            if (account != null) {
                Log.e("handleSignInResult", "working start if");
                String id=account.getId();
                String fname=""+account.getGivenName();
                String lname=""+account.getFamilyName();
    ...
    private void Call_Api_For_Signup(String id,
        ...
        Log.e("Call_Api Signup", "Working start");
        ...
        ApiRequest.Call_Api(this, Variables.SignUp, parameters, new Callback() {
            ...
            public void Responce(String resp) {
                Log.e("Call_Api Signup", "Working response");
                Functions.cancel_loader();
    ...
    public void Parse_signup_data(String loginData){
        try {
            ...
            if(code.equals("200")){
                ...
                top_view.setVisibility(View.GONE);
                Log.e("Parse_signup_data", "Working start activity");
                finish();
                ...
                Log.e("Parse_signup_data", "else working");
