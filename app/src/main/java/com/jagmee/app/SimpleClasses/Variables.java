...
public class Variables {
    ...
    public static final String app_folder=root+"/Jagmee/";
    ...
    public static String gif_api_key1="gif_api_key";

    public static final String privacy_policy="https://xcodedevelopers.in";


    public static final  String main_domain="https://anmgroup.co.in/swag/";
    ...
    public static String ReportVideo                = api_domain+"reportVideoAndUser";
