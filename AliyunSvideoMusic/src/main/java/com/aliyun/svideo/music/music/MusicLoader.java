...
public class MusicLoader {
    ...
    private final VideoQuery mVideoQuery;
    ...
    public MusicLoader(Context context) {
        ...
        mVideoQuery = new VideoQuery(context);
    }
    ...
    public void loadLocalVideo() {
        mVideoQuery.setOnResProgressListener(new VideoQuery.OnResProgressListener() {
            @Override
            public void onResProgress(ArrayList<MusicFileBean> musics) {
                List<EffectBody<MusicFileBean>> effectBodyList = new ArrayList<>();
                for (MusicFileBean musicFileBean : musics) {
                ...
                if (callback != null) {
                    callback.onLoadLocalMusicVideoCompleted(effectBodyList);
                }
            }
        });
        mVideoQuery.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    public interface LoadCallback {
        void onLoadLocalMusicVideoCompleted(List<EffectBody<MusicFileBean>> loacalMusicVideo);
