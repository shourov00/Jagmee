...
public class ControlView extends RelativeLayout implements View.OnTouchListener {
    ...
    private LinearLayout mAlivcBeauty;
    private LinearLayout mAlivcSticker;
    ...
    private void assignViews() {
        ...
        mAlivcBeauty = findViewById(R.id.ll_beauty_face);
        mAlivcSticker = findViewById(R.id.ll_gif_effect);
    ...
    private void setViewListener() {
        ...
        // 点击美颜
        mAlivcBeauty.setOnClickListener(new OnClickListener() {
        ...
        // 点击动图
        mAlivcSticker.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (FastClickUtil.isFastClick()) {
                    return;
    ...
    private void updateTittleView() {
        if (recordState == RecordState.STOP) {
            ...
            mAlivcBeauty.setVisibility(VISIBLE);
            mAlivcSticker.setVisibility(VISIBLE);
            ...
            mAlivcBeauty.setVisibility(GONE);
            mAlivcSticker.setVisibility(GONE);
